...
public class PeijianfenleiController {
    ...
    public R save(@RequestBody PeijianfenleiEntity peijianfenlei, HttpServletRequest request){
    	peijianfenlei.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<PeijianfenleiEntity> wrapper = new EntityWrapper<PeijianfenleiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = peijianfenleiService.selectCount(wrapper);
