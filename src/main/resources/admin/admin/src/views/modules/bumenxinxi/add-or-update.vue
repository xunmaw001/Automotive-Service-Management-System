<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="部门编号" prop="bumenbianhao">
					<el-input v-model="ruleForm.bumenbianhao" placeholder="部门编号" clearable  :readonly="ro.bumenbianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="部门编号" prop="bumenbianhao">
					<el-input v-model="ruleForm.bumenbianhao" placeholder="部门编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="date" v-if="type!='info'" label="创建时间" prop="chuangjianshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-else-if="ruleForm.chuangjianshijian" label="创建时间" prop="chuangjianshijian">
