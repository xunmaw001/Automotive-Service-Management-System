<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'" label="售后编号" prop="shouhoubianhao">
					<el-input v-model="ruleForm.shouhoubianhao" placeholder="售后编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-else-if="ruleForm.shouhoubianhao" label="售后编号" prop="shouhoubianhao">
					<el-input v-model="ruleForm.shouhoubianhao" placeholder="售后编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="客户地址" prop="kehudizhi">
					<el-input v-model="ruleForm.kehudizhi" placeholder="客户地址" clearable  :readonly="ro.kehudizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="客户地址" prop="kehudizhi">
					<el-input v-model="ruleForm.kehudizhi" placeholder="客户地址" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="date" v-if="type!='info'" label="下次保养" prop="xiacibaoyang">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.xiacibaoyang" 
						type="date"
						:readonly="ro.xiacibaoyang"
						placeholder="下次保养"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-else-if="ruleForm.xiacibaoyang" label="下次保养" prop="xiacibaoyang">
					<el-input v-model="ruleForm.xiacibaoyang" placeholder="下次保养" readonly></el-input>
				</el-form-item>
