	...
	<div class="addEdit-block" :style='{"padding":"30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="select" v-if="type!='info'"  label="部门名称" prop="bumenmingcheng">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="select" v-if="type!='info'"  label="岗位名称" prop="gangweimingcheng">
					<el-select :disabled="ro.gangweimingcheng" v-model="ruleForm.gangweimingcheng" placeholder="请选择岗位名称" >
						<el-option
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="岗位名称" prop="gangweimingcheng">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="select" v-if="type!='info'"  label="员工状态" prop="yuangongzhuangtai">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="员工状态" prop="yuangongzhuangtai">
