...
<div :style='{"width":"calc(100% - 40px)","padding":"30px 20px 40px","margin":"20px auto 0","position":"relative","background":"rgba(255,255,255,.3)"}'>
    ...
    >
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="汽车名称" prop="qichemingcheng">
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="汽车价格" prop="qichejiage">
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}'  label="委托代购" prop="weituodaigou">
            <el-select v-model="ruleForm.weituodaigou" placeholder="请选择委托代购"  >
              <el-option
                  v-for="(item,index) in weituodaigouOptions"
                  :key="index"
                  :label="item"
                  :value="item">
              </el-option>
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="购买时间" prop="goumaishijian" >
              <el-date-picker
...
<script>
  export default {
    data() {
      return {
        ...
        rules: {
          ...
          qichejiage: [
            { required: true, message: '汽车价格不能为空', trigger: 'blur' },
    ...
    computed: {
        ...
        zongjine:{
            get: function () {
                return 1*this.ruleForm.qichejiage*this.ruleForm.shuliang
            }
        },
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='weituodaigou'){
              this.ruleForm.weituodaigou = obj[o];
              this.ro.weituodaigou = true;
              continue;
            }
            if(o=='yonghuzhanghao'){
        ...
        this.weituodaigouOptions = "个人,公司".split(',')
      },
