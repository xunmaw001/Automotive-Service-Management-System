...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"30px 20px 30px","margin":"20px 7% 0","borderColor":"#00adb5","alignItems":"center","borderRadius":"0px","flexWrap":"wrap","background":"none","borderWidth":"0px 0 0px 0","display":"flex","width":"100%","borderStyle":"dashed","height":"auto"}'>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>配件名称</div>
        <el-input v-model="formSearch.peijianmingcheng" placeholder="配件名称" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>型号</div>
        <el-input v-model="formSearch.xinghao" placeholder="型号" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>适用品牌</div>
        <el-input v-model="formSearch.shiyongpinpai" placeholder="适用品牌" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>适用车系</div>
        <el-input v-model="formSearch.shiyongchexi" placeholder="适用车系" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="isAuth('qichepeijian','新增')" :style='{"cursor":"pointer","padding":"0px 10px","boxShadow":"0px 0px 0px #f8a412","margin":"0px 10px 0 0","borderColor":"#72bb3d","color":"#333","minWidth":"90px","outline":"none","borderRadius":"30px","background":"linear-gradient(30deg, rgba(206,255,170,1) 0%, rgba(114,187,61,1) 28%, rgba(206,255,170,1) 68%, rgba(114,187,61,1) 100%)","borderWidth":"0px 1px 2px","width":"auto","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="primary" @click="add('/index/qichepeijianAdd')"><i v-if="true" :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"padding":"0px 0 20px","margin":"20px 7% 0px","background":"none","flex":"1","width":"100%","minWidth":"750px","order":"2"}'>
		...
		<div class="list2 index-pv1" :style='{"padding":"0 0px","margin":"20px 0 0","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<div :style='{"border":"0px solid #eee","cursor":"pointer","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 20px","display":"flex","justifyContent":"space-between","borderRadius":"0px","flexWrap":"wrap","background":"none","width":"49.5%","fontSize":"0","position":"relative","height":"320px"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				...
				<img :style='{"cursor":"pointer","padding":"10px","boxShadow":"0px 6px 6px -6px #80afba","borderColor":"#0087a7 #bdeaf4 #0087a7 #bdeaf4","margin":"0px 0 0","objectFit":"cover","display":"inline-block","borderRadius":"20px","borderWidth":"1px 2px 2px 1px","background":"none","width":"48%","borderStyle":"dotted","height":"100%"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" class="image" />
				<div class="item-info" :style='{"padding":"10px 0px","boxShadow":"0px 12px 12px -12px #80afba","alignSelf":"center","borderColor":"#bdeaf4 #0087a7 #bdeaf4 #0087a7","margin":"0px 0 0","display":"flex","justifyContent":"center","overflow":"hidden","borderRadius":"10px","flexWrap":"wrap","borderWidth":"1px 1px 3px 4px","background":"url(http://codegen.caihongy.cn/20230210/7d53b0e6bd6b44dc87a1dcd33f7af58f.gif)","width":"50%","borderStyle":"solid","height":"280px"}'>
					<div :style='{"padding":"0 6px","borderColor":"#9dcde9","margin":"0 10px 0 0","color":"#333","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"center","overflow":"hidden","background":"none","borderWidth":"0 0 0px","width":"32px","lineHeight":"16px","fontSize":"14px","borderStyle":"dotted"}' class="name ">{{item.peijianmingcheng}}</div>
					<div :style='{"padding":"0 6px","borderColor":"#9dcde9","margin":"0 10px 0 0","color":"#333","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"center","overflow":"hidden","background":"none","borderWidth":"0 0 0px","width":"32px","lineHeight":"16px","fontSize":"14px","borderStyle":"dotted"}' class="name ">{{item.shiyongpinpai}}</div>
...
<script>
  export default {
    ...
    methods: {
      ...
      getFenlei() {
        this.$http.get('option/peijianfenlei/peijianfenlei').then(res => {
          if (res.data.code == 0) {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.peijianmingcheng != '') searchWhere.peijianmingcheng = '%' + this.formSearch.peijianmingcheng + '%';
        if (this.formSearch.xinghao != '') searchWhere.xinghao = '%' + this.formSearch.xinghao + '%';
        if (this.formSearch.shiyongpinpai != '') searchWhere.shiyongpinpai = '%' + this.formSearch.shiyongpinpai + '%';
        if (this.formSearch.shiyongchexi != '') searchWhere.shiyongchexi = '%' + this.formSearch.shiyongchexi + '%';
        if (this.curFenlei != '全部') searchWhere.peijianfenlei = this.curFenlei;
        this.$http.get('qichepeijian/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/qichepeijianDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
